...
public class FragmentQuestionTY extends Fragment {
    View view;
    ImageView imgView,imgView1,imgView2;
    Button savebtn,savebtn1,savebtn2;

    public FragmentQuestionTY() {
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_ty_qp, container, false);

        imgView=view.findViewById(R.id.tyQTSImageView);
        imgView1=view.findViewById(R.id.tyQTSImageView1);
        imgView2=view.findViewById(R.id.tyQTSImageView2);

        savebtn=view.findViewById(R.id.tyQTSDownloadBtn);
        savebtn1=view.findViewById(R.id.tyQTSDownloadBtn1);
        savebtn2=view.findViewById(R.id.tyQTSDownloadBtn2);
